...
declare function getScramble(mode: string, len: number, pb: number): string;
export { p133, p222, p223, p333lse, pClock, pGear, pMega, pPyra, p444, pScramble, getScramble, p333, pSq1, pSkewb, pUtils, pKilo, };
