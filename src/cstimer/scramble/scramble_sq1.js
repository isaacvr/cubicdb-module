...
exports.square1SolverGetRandomScramble = square1SolverGetRandomScramble;
...
function FullCube_getSquare(obj, sq) {
    ...
    sq.cornperm = (0, mathlib_1.get8Perm)(obj.prm);
    ...
    for (; b < 8; a += 3, ++b)
        obj.prm[b] = FullCube_pieceAt(obj, a) >> 1;
    sq.edgeperm = (0, mathlib_1.get8Perm)(obj.prm);
    sq.ml = obj.ml;
}
...
function FullCube() { }
var _ = (FullCube_FullCube__Ljava_lang_String_2V.prototype =
    FullCube.prototype);
_.dl = 10062778;
_.dr = 14536702;
_.ml = 0;
...
function Square_init() {
    ...
    pos = [];
    for (i = 0; i < 40320; ++i) {
        (0, mathlib_1.set8Perm)(pos, i);
        (0, mathlib_1.circle)(pos, 2, 4)(pos, 3, 5);
        Square_TwistMove[i] = (0, mathlib_1.get8Perm)(pos);
        (0, mathlib_1.set8Perm)(pos, i);
        (0, mathlib_1.circle)(pos, 0, 3, 2, 1);
        Square_TopMove[i] = (0, mathlib_1.get8Perm)(pos);
        (0, mathlib_1.set8Perm)(pos, i);
        (0, mathlib_1.circle)(pos, 4, 7, 6, 5);
        Square_BottomMove[i] = (0, mathlib_1.get8Perm)(pos);
    }
    for (i = 0; i < 80640; ++i) {
        SquarePrun[i] = -1;
    }
...
function square1CubeShapeParityScramble(type, length, cases) {
    ...
    Square_$clinit();
    CSPInit();
    var idx = (0, mathlib_1.rndEl)(cspcases[(0, scramble_1.fixCase)(cases, cspprobs)]);
    var scrambleString = Search_solution(search, FullCube_randomCube(idx));
    return scrambleString;
}
(0, scramble_1.regScrambler)("sqrs", square1SolverGetRandomScramble);
(0, scramble_1.regScrambler)("sqrcsp", square1CubeShapeParityScramble, [cspfilter, cspprobs]);
