...
var solv = new mathlib_1.Solver(3, 3, [
...
var moveOris = [undefined, [0, 1, 0, 1, 3], [1, 0, 1, 0, 3]];
// @ts-ignore
var oriCoord = new mathlib_1.coord("o", 7, -3);
function doPermMove(arr, m) {
    (0, mathlib_1.acycle)(arr, movePieces[m]);
}
function doOriMove(arr, m) {
    (0, mathlib_1.acycle)(arr, movePieces[m], 1, moveOris[m]);
}
var cFacelet = [
    [3, 4, 9],
    [1, 20, 5],
...
function checkNoBar(pidx, oidx) {
    var perm = (0, mathlib_1.set8Perm)([], pidx, 7);
    var ori = oriCoord.set([], oidx);
    var f = [];
    for (var i = 0; i < 24; i++) {
        f[i] = i >> 2;
    }
    (0, mathlib_1.fillFacelet)(cFacelet, f, perm, ori, 4);
...
var egllprobs = (0, mathlib_1.idxArray)(egll_map, 2);
var egllfilter = (0, mathlib_1.idxArray)(egll_map, 3);
var tcllpprobs = (0, mathlib_1.idxArray)(tcllp_map, 2);
var tcllpfilter = (0, mathlib_1.idxArray)(tcllp_map, 3);
var tcllnprobs = (0, mathlib_1.idxArray)(tclln_map, 2);
var tcllnfilter = (0, mathlib_1.idxArray)(tclln_map, 3);
var lsallprobs = (0, mathlib_1.valuedArray)(lsall_map.length, 1);
var lsallfilter = (0, mathlib_1.idxArray)(lsall_map, 1);
function getScramble(type, length, state) {
    ...
    do {
        ...
        if (type == "222o" || type == "222so") {
            perm = (0, mathlib_1.rn)(5040);
            ori = (0, mathlib_1.rn)(729);
            lim = 3;
        }
        else if (type == "222eg") {
            ori = egmap[state & 0x7];
            perm = [0, 2, 3, 4, 5, 1][state >> 3];
            var arr = (0, mathlib_1.set8Perm)([0, 0, 0, 0].concat(egperms[perm]), (0, mathlib_1.rn)(24), 4);
            perm = (0, mathlib_1.get8Perm)(arr, 7);
            var rndU = (0, mathlib_1.rn)(4);
    ...
    return solv.toStr(((_a = solv.search([perm, ori], maxl)) === null || _a === void 0 ? void 0 : _a.reverse()) || [], "URF", "'2 ");
}
function getLLScramble(type, length, cases) {
    ...
    if (type == "222tcp") {
        llcase = tcllp_map[(0, scramble_1.fixCase)(cases, tcllpprobs)];
        ori = [0, 0, 0, 0, 1, 0, 0];
        perm = perm.concat(egperms[0]);
    }
    else if (type == "222tcn") {
        llcase = tclln_map[(0, scramble_1.fixCase)(cases, tcllnprobs)];
        ori = [0, 0, 0, 0, 2, 0, 0];
        perm = perm.concat(egperms[0]);
    }
    else if (type == "222eg0") {
        llcase = egll_map[(0, scramble_1.fixCase)(cases, egllprobs)];
        perm = perm.concat(egperms[0]);
    }
    else if (type == "222eg1") {
        llcase = egll_map[(0, scramble_1.fixCase)(cases, egllprobs)];
        perm = perm.concat(egperms[2 + (0, mathlib_1.rn)(4)]);
    }
    else if (type == "222eg2") {
        llcase = egll_map[(0, scramble_1.fixCase)(cases, egllprobs)];
        ...
        perm = perm.concat(egperms[0]);
        var perm4 = (0, mathlib_1.rndPerm)(4);
        perm4.push(perm4[3]);
        perm4[3] = 4;
        llcase = [0, lsall_map[(0, scramble_1.fixCase)(cases, lsallprobs)][0]];
        for (var i = 0; i < 5; i++) {
            llcase[0] |= perm4[i] << (i * 4);
        }
        ncubie = 5;
    }
    var rndA = (0, mathlib_1.rn)(4);
    while (rndA-- > 0) {
        doPermMove(perm, 0);
    }
    ...
    var p = (0, mathlib_1.get8Perm)(perm, 7);
    var o = oriCoord.get(ori);
    return solv.toStr(((_a = solv.search([p, o], 9)) === null || _a === void 0 ? void 0 : _a.reverse()) || [], "URF", "'2 ");
}
(0, scramble_1.regScrambler)(["222o", "222so", "222nb"], getScramble)("222eg0", getLLScramble, [
    egllfilter,
    egllprobs,
